...
public class LoginUserDetailsController {
    ...
    public ResponseEntity<?> getAllLoginDetails() {
        ...
        List<LoginUserDetailsDTO> loginList = loginUserDetailsService.getAllLoginUserDetails();
    ...
    public ResponseEntity<?> addLoginDetails(@RequestBody UserFullDTO userdata) throws NoSuchAlgorithmException {
        Map<String, Object> map = new LinkedHashMap<String, Object>();
        LoginUserDetailsDTO loginDetails = loginUserDetailsService.addLoginUserDetails(userdata);
...
//    }
    ...
    public ResponseEntity<?> validateEmail(@RequestBody String email) {
        Map<String, Object> map = new LinkedHashMap<String, Object>();
        boolean valid = loginUserDetailsService.validateEmail(email);
    ...
    @GetMapping("/getemailbyloginid/{loginId}")
    public ResponseEntity<?> getEmailByLoginId(@PathVariable int loginId) {
        System.out.println("Controller 1");
        Map<String, Object> map = new LinkedHashMap<String, Object>();
        LoginUserDetailsDTO user = loginUserDetailsService.getEmailByLoginId(loginId);
